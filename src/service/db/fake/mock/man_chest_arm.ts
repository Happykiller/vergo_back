  ...
  workout: [
    {
      ...
      sets: [
        {
          rep: 4,
          slugs: ['jumping_jacks', 'arm_circles', 'dynamic_chest_stretch', 'shoulder_shrugs'],
          duration: 40,
          rest: 20,
          pause: 60,
        },
      ...
      sets: [
        {
          ...
          duration: 40,
          rest: 60,
          slugs: ['standing_dumbbell_shoulder_press'],
        },
        {
          rep: 3,
          duration: 40,
          rest: 60,
          slugs: ['lateral_raises'],
        },
        {
          rep: 3,
          duration: 40,
          rest: 60,
          slugs: ['bent-over_reverse_flyes'],
        },
        {
          rep: 3,
          duration: 40,
